...
import pediatrican from "../assets/pediatrican.jpeg";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <h2 className="animate-title text-3xl sm:text-4xl md:text-5xl font-black text-[#1a244f] leading-tight tracking-tight uppercase">
              ...
              <span className="text-[#0095d5]">pediatrician</span> in Patna?
            </h2>
            ...
            <div className="animate-paragraphs space-y-5 text-[16px] md:text-[17px] text-gray-600 font-medium leading-relaxed max-w-3xl">
              <p>
                MGM Hospital provides comprehensive child healthcare, including
                newborn care, vaccinations, growth monitoring, and treatment for
                childhood illnesses. Our experienced child specialist in Patna
                ensures expert medical care for infants, children, and
                adolescents in a safe environment.From routine pediatric
                consultations to emergency care and NICU support, our pediatric
                team is dedicated to helping children grow healthy and strong.
              </p>
            </div>
