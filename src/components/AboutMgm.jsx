    ...
    >
      <div className="max-w-[90vw] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
             ...
             {/* Left Block: Interactive Parallax/Tilt Canvas Workspace */}
          ...
          {/* Right Block: Dynamic Content Layout */}
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-8">
            ...
            <h2 className="animate-title text-3xl sm:text-4xl md:text-5xl font-black text-[#1a244f] leading-tight tracking-tight uppercase">
              Looking for the best <span className="text-[#0095d5]">gynecologists</span> in Patna? 
            ...
            <div className="animate-paragraphs space-y-5 text-[16px] md:text-[17px] text-gray-600 font-medium leading-relaxed max-w-3xl">
              <p>
                MGM Hospital offers expert care for pregnancy, PCOS, infertility, menstrual disorders, high-risk pregnancies, and women's health. Our experienced gynecologists at Patna's No. 1 Women  and Childcare Hospital provide advanced treatment with compassionate care for every stage of a woman's life.
              </p>
              <p>
                Recognized as a trusted destination for pregnancy care in Patna , our team of gynecologists  focuses on personalized treatment, accurate diagnosis, and compassionate care.
              </p>
            </div>
